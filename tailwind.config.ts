  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        ...
        sansx: ['Inter', 'ui-sans-serif', 'system-ui', '-apple-system', 'Segoe UI', 'Roboto', 'Helvetica', 'Arial', 'sans-serif'],
        serif: ['Bodoni Moda', 'ui-serif', 'Georgia', 'serif'],
        serifx: ['Bodoni Moda', 'ui-serif', 'Georgia', 'serif'],
      ...
      animation: {
        ...
        "text-reveal": "text-reveal 0.4s ease-out",
